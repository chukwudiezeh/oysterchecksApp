        ...
        <div class="container">
           ...
           <center>  <div class="col-lg-12 pb-5 pl-5">
                ...
                <div class="col-md-12 col-lg-4">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h5><img src="{{secure_asset('/landing_assets/img/icon_1.png')}}" width="50px"> Unbeatable IT Expertise</h5>
                 ...
                 <div class="col-md-12 col-lg-4">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h5><img src="{{secure_asset('/landing_assets/img/icon_2.png')}}" width="50px"> Creative And Innovative</h5>
                 ...
                 <div class="col-md-12 col-lg-4">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h5><img src="{{secure_asset('/landing_assets/img/icon_3.png')}}" width="50px"> Client Support</h5>
               ...
               <div class="row justify-content-between align-items-center">
                <div class="col-md-12 col-lg-4">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h5><img src="{{secure_asset('/landing_assets/img/icon_2.png')}}" width="50px"> Data Security</h5>
                        <p>Oysterchecks provides you an access to a platform built on complex data analytics technology by highly-experienced professionals to help in meeting your specific needs. We provide comprehensive automated Background Checks, KYC , Transaction Monitoring, AML screening services in a single API.</p>
                 ...
                 <div class="col-md-12 col-lg-4">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h5><img src="{{secure_asset('/landing_assets/img/icon_1.png')}}" width="50px">Operations On Global Basis</h5>
             ...
             <div class="col-md-12 col-lg-4">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                            <h5><img src="{{secure_asset('/landing_assets/img/icon_3.png')}}" width="50px"> Always With You Throughout Your Journey</h5>
               ...
               <div class="row justify-content-between align-items-center">
                <div class="col-md-12 col-lg-4">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h5><img src="{{secure_asset('/landing_assets/img/icon_2.png')}}" width="50px"> Operations On Global Basis</h5>
                        <p>We have collaborated with other international bodies which have provided us with global access and processing of data. This has enabled us to conduct various checks on any employee on a global basis. This should eliminate your worry of hiring employees from other countries because our services will provide global background check report.</p></div>
                </div>
                 <div class="col-md-12 col-lg-4">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h5><img src="{{secure_asset('/landing_assets/img/icon_1.png')}}" width="50px">Oysterchecks Team</h5>
             ...
             <div class="col-md-12 col-lg-4">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                            <h5><img src="{{secure_asset('/landing_assets/img/icon_3.png')}}" width="50px"> Automated Services</h5>
