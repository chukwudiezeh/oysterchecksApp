                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-md-4">
                                <div class="mt-2 mb-2 px-2 font-15"><span class="text-muted mr-2">Created At:</span> {{ \Carbon\Carbon::createFromTimeString($address_verification->addressVerificationDetail->created_at)->format('d-m-Y h:ia')}}</div>
                            </div>
