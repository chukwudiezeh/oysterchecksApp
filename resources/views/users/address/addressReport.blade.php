                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-md-4">
                                <div class="mt-2 mb-2 px-2 font-15"><span class="text-muted mr-2">Accepted At :</span> {{ \Carbon\Carbon::parse('d-m-Y, H:ia', $address_verification->addressVerificationDetail->accepted_at)->format('d-m-Y, h:ia')}}</div>
                            </div>
                            @endif
                            <div class="col-md-4">
