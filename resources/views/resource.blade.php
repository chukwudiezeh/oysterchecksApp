    ...
    <section class="about-us-section ptb-100">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-md-12 col-lg-6">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h4><img src="{{secure_asset('/landing_assets/img/screening.jpg')}}" width="100px">Screening Regulations</h4>
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h4><img src="{{secure_asset('/landing_assets/img/data.jpg')}}" width="100px"> Data Protection Compliance</h4>
          ...
          <div class="col-md-12 col-lg-12 pt-2">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h4><img src="{{secure_asset('/landing_assets/img/com.jpg')}}" width="100px">Data Protection Compliance</h4>
                        <p>Oysterchecks is registered with the Information Commissioner’s Office and strictly operates in compliance with rules stipulated under the Data Act 1998. This act regulates how a company gathers, handles, stores, retains and disposes personal information.</p>
         ...
         <div class="col-md-12 col-lg-6 pt-2">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h4><img src="{{secure_asset('/landing_assets/img/criminal.jpg')}}" width="100px"> Criminal Checks Records Compliance</h4>
             ...
             <div class="col-md-12 col-lg-6 pt-2">
                    <div class="video-promo-content mb-md-4 mb-lg-0">
                        <h2><img src="{{secure_asset('/landing_assets/img/com.jpg')}}" width="100px">Compliance Standards</h2>
