...
class InputFieldSeeder extends Seeder
{
    ...
    public function run()
    {
        $input_fields = [
            ...
            ['slug' => 'individual_address', 'name'=>'street', 'placeholder'=>'Enter Street Name', 'type'=>'text', 'is_required'=>'1', 'label'=>'Candidate\'s Street', 'inputid'=>'street'],  
            ['slug' => 'individual_address', 'name'=>'Sub_street', 'placeholder'=>'Enter Sub-Street Name', 'type'=>'text', 'is_required'=>'0', 'label'=>'Candidate\'s sub-Street', 'inputid'=>'sub_street'],
            ...
            ['slug' => 'individual_address', 'name'=>'lga', 'placeholder'=>'Enter LGA', 'type'=>'text', 'is_required'=>'0', 'label'=>'Candidate\'s LGA', 'inputid'=>'lga'],
        
            ['slug' => 'reference_address', 'name'=>'first_name', 'placeholder'=>'Enter Guarantor\'s First Name', 'type'=>'text', 'is_required'=>'1', 'label'=>'First Name', 'inputid'=>'first_name'], 
            ...
            ['slug' => 'reference_address', 'name'=>'phone', 'placeholder'=>'Enter Guarantor\'s Phone Number', 'type'=>'text', 'is_required'=>'1', 'label'=>'Phone', 'inputid'=>'phone'],
            ['slug' => 'reference_address', 'name'=>'email', 'placeholder'=>'Enter Guarantor\'s Email', 'type'=>'text', 'is_required'=>'1', 'label'=>'Email', 'inputid'=>'email'],  
            ['slug' => 'reference_address', 'name'=>'image', 'placeholder'=>'Upload Guarantor\'s Picture', 'type'=>'file', 'is_required'=>'1', 'label'=>'Image', 'inputid'=>'image'],
            
            ['slug' => 'reference_address', 'name'=>'flat_number', 'placeholder'=>'E.g. 1st floor', 'type'=>'text', 'is_required'=>'0', 'label'=>'Flat Number', 'inputid'=>'flat_number'],
            ['slug' => 'reference_address', 'name'=>'building_name', 'placeholder'=>'Enter Building Name', 'type'=>'text', 'is_required'=>'0', 'label'=>'Building Name', 'inputid'=>'building_name'], 
            ['slug' => 'reference_address', 'name'=>'building_number', 'placeholder'=>'E.g. 6 or Number 6 or No. 6', 'type'=>'text', 'is_required'=>'1', 'label'=>'Building Number', 'inputid'=>'building_number'], 
            ['slug' => 'reference_address', 'name'=>'landmark', 'placeholder'=>'Enter nearest Landmark or bustop', 'type'=>'text', 'is_required'=>'1', 'label'=>'Nearest Landmark', 'inputid'=>'landmark'],
            ['slug' => 'reference_address', 'name'=>'street', 'placeholder'=>'Enter Street', 'type'=>'text', 'is_required'=>'1', 'label'=>'Street', 'inputid'=>'street'],  
            ['slug' => 'reference_address', 'name'=>'Sub_street', 'placeholder'=>'Enter Sub-Street', 'type'=>'text', 'is_required'=>'0', 'label'=>'Sub-street', 'inputid'=>'sub_street'],
            ...
            ['slug' => 'reference_address', 'name'=>'lga', 'placeholder'=>'Enter LGA', 'type'=>'text', 'is_required'=>'0', 'label'=>'LGA', 'inputid'=>'lga'],
    
            ['slug' => 'business_address', 'name'=>'name', 'placeholder'=>'Enter Contact Person\'s Name', 'type'=>'text', 'is_required'=>'1', 'label'=>'Name', 'inputid'=>'name'], 
            ['slug' => 'business_address', 'name'=>'email', 'placeholder'=>'Enter Contact\'s Email', 'type'=>'text', 'is_required'=>'1', 'label'=>'Email', 'inputid'=>'email'],
            ['slug' => 'business_address', 'name'=>'phone', 'placeholder'=>'Enter Contact\'s Phone', 'type'=>'text', 'is_required'=>'1', 'label'=>'Phone', 'inputid'=>'phone'],  
            ...
            ['slug' => 'business_address', 'name'=>'flat_number', 'placeholder'=>'E.g. 1st floor', 'type'=>'text', 'is_required'=>'0', 'label'=>'Flat Number', 'inputid'=>'flat_number'],
            ['slug' => 'business_address', 'name'=>'building_name', 'placeholder'=>'Enter Building Name', 'type'=>'text', 'is_required'=>'0', 'label'=>'Building Name', 'inputid'=>'building_name'], 
            ['slug' => 'business_address', 'name'=>'building_number', 'placeholder'=>'E.g. 6 or Number 6 or No. 6', 'type'=>'text', 'is_required'=>'1', 'label'=>'Building Number', 'inputid'=>'building_number'], 
            ['slug' => 'business_address', 'name'=>'landmark', 'placeholder'=>'Enter nearest Landmark or bustop', 'type'=>'text', 'is_required'=>'1', 'label'=>'Nearest Landmark', 'inputid'=>'landmark'],
            ['slug' => 'business_address', 'name'=>'street', 'placeholder'=>'Enter Street', 'type'=>'text', 'is_required'=>'1', 'label'=>'Street', 'inputid'=>'street'],  
            ['slug' => 'business_address', 'name'=>'Sub_street', 'placeholder'=>'Enter Sub-Street', 'type'=>'text', 'is_required'=>'0', 'label'=>'Sub-street', 'inputid'=>'sub_street'],
            ['slug' => 'business_address', 'name'=>'state', 'placeholder'=>'Enter State', 'type'=>'text', 'is_required'=>'1', 'label'=>'State', 'inputid'=>'state'],
            ['slug' => 'business_address', 'name'=>'city', 'placeholder'=>'Enter City', 'type'=>'text', 'is_required'=>'1', 'label'=>'City', 'inputid'=>'city'],
            ['slug' => 'business_address', 'name'=>'lga', 'placeholder'=>'Enter LGA', 'type'=>'text', 'is_required'=>'0', 'label'=>'LGA', 'inputid'=>'lga'],
